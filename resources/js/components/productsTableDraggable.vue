    ...
    <div class="products-table-wrap">
        ...
        <div class="table-wrap">
            ...
            <div v-if="products.length != 0" class="lazy-table">
                ...
                <draggable forceFallback="true" v-if="products.length != 0" :list="products" @change="change" class="table-body" :sortable="{scroll: true}">
    ...
    export default {
        ...
        methods: {
            handleScroll(event) {
                if (this.ready == true && this.progress == false && this.products.length != 0 && this.search == 0) {
                    ...
                    if (isVisible) {
                        ...
                        this.$http.get('/getData?category=' + this.categoryId + '&lazy=' + this.lazy)
            ...
            change() {
                ...
                this.$http.post('/changeSortProducts', { products: this.products, category_id: this.categoryId })
                .then(function() {
                });
            },
            deleteLine(id) {
                ...
                .then(function(response) {
                    ...
                    if (response.data.success) {
                        ...
                        if (this.query.length > 1) {
                            this.search = 1;
                            this.$http.get('/searchTableProducts?query=' + this.query + '&category=' + this.categoryId)
                            .then(function(response) {
                                this.products = (response.data == null || response.data == 0) ? [] : response.data;
                                this.ready = false;
                            });
                            ...
                            this.search = 0;
                            this.$http.get('/getTableData?category=' + this.categoryId)
                            .then(function(response) {

...
<section class="about-company">
    ...
    <div class="company-text">
        ...
        <ul>У нас вы можете:
            <li>воспользоваться услугой «Комплексные поставки» и купить оборудование по вашей спецификации в нашем торговом доме от разных производителей одной закупкой с доставкой прямо к вам;</li>
            <li>получить профессиональную консультацию менеджеров и особые условия для оптовых заказчиков, а для постоянных клиентов действуют партнерские программы. Мы постоянно работаем над улучшением процесса взаимодействия с покупателями и расширением ассортимента, чтобы ваша покупка была выгодной и комфортной;</li>
            <li>купить тепловое оборудование: пароконвектоматы, крвекционные печи, плиты индукционные, шкафы жарочные, печи для пиццы, электроварки, фритюрницы, рисоварки, макароноварки, грили, оборудование для шаурмы и шашлыка, блинницы, вафельницы, тепловые витрины;</li>
            <li>купить холодильное оборудование: холодильные и морозильные витринф, витрины для баров, шкафы холодильные, шкафы морозильные, лари морозильные, шкафы для шоковой заморозки;</li>
            <li>купить барное оборудование: кофемашины, соковыжималки, блендеры, тостеры, миксеры, кофемолки;</li>
        </ul>
    </div>
</section>
<div class="offers">

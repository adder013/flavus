...
<div class="news-and-subscribe">
    ...
    <section class="promotions">
        <h2><a href="{{ URL::to('/about/deals') }}">Новости индустрии Horeca<span><svg aria-hidden="true" data-prefix="fas" data-icon="chevron-right" class="svg-inline--fa fa-chevron-right fa-w-10" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg></span></a></h2>
...
<section class="about-company">
    ...
    <div class="company-text">
        <h2>О компании</h2>
        <p>FLAVUS – поставщик рядом с вами, мы поставляем холодильное, барное, тепловое оборудование для баров, кофеен, столовых и блинных, шашлычных и пекарен, кондитерских  баров.  У нас вы купите оборудование по ценам заводов или ниже, и мы доставим вам до самого дальнего города, населенного пункта где есть пункты выдачи OZON или есть терминалы СДЭК. Так же предоставляем гарантийный и пост гарантийный официальный сервис.</p>
        <p>У нас вы можете воспользоваться услугой «Комплексные поставки» и купить оборудование по вашей спецификации в нашем торговом доме от разных производителей одной закупкой с доставкой прямо к вам.</p>
        <p>У нас вы можете получить профессиональную консультацию менеджеров и особые условия для оптовых заказчиков, а для постоянных клиентов действуют партнерские программы. Мы постоянно работаем над улучшением процесса взаимодействия с покупателями и расширением ассортимента, чтобы ваша покупка была выгодной и комфортной.</p>
        <p>У нас можно купить тепловое оборудование: пароконвектоматы, крвекционные печи, плиты индукционные, шкафы жарочные, печи для пиццы, электроварки, фритюрницы, рисоварки, макароноварки, грили, оборудование для шаурмы и шашлыка, блинницы, вафельницы, тепловые витрины.</p>
        <p>У нас можно купить:  холодильное оборудование: холодильные и морозильные витринф, витрины для баров, шкафы холодильные, шкафы морозильные, лари морозильные, шкафы для шоковой заморозки.</p>
        <p>У нас можно купить барное оборудование: кофемашины, соковыжималки, блендеры, тостеры, миксеры, кофемолки.</p>
    </div>
</section>
<div class="offers">
    ...
    <a href="{{ URL::to('/about/brands') }}" class="block">
        ...
        <div class="text">
            <div class="title">OZON & FLAVUS</div>
